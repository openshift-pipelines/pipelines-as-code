...
func TestGithubSkipCIPullRequest(t *testing.T) {
	...
	g.Cnx.Clients.Log.Infof("✓ Verified that [skip ci] prevented PipelineRun creation")
}
...
func TestGithubSkipCIPush(t *testing.T) {
	...
	g.Cnx.Clients.Log.Infof("✓ Verified that [skip ci] prevented PipelineRun creation on push")
}
...
func TestGithubSkipCITestCommand(t *testing.T) {
	...
	g.Cnx.Clients.Log.Infof("✓ Verified [skip tkn] prevented initial PipelineRun")
