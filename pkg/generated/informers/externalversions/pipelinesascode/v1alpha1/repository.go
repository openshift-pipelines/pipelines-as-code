...
import (
	...
	v1alpha1 "github.com/openshift-pipelines/pipelines-as-code/pkg/generated/listers/pipelinesascode/v1alpha1"
...
func (f *repositoryInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&pipelinesascodev1alpha1.Repository{}, f.defaultInformer)
}
