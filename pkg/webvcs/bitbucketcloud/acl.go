...
func (v *VCS) IsAllowed(_ context.Context, event *info.Event) (bool, error) {
...
func (v *VCS) isWorkspaceMember(event *info.Event) (bool, error) {
...
func (v *VCS) isAllowedFromOwnerFile(event *info.Event) (bool, error) {
...
func (v *VCS) checkMember(event *info.Event) (bool, error) {
...
func (v *VCS) checkOkToTestCommentFromApprovedMember(event *info.Event) (bool, error) {
