...
import (
	...
	bbv1test "github.com/openshift-pipelines/pipelines-as-code/pkg/webvcs/bitbucketserver/test"
...
func TestIsAllowed(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			bbclient, mux, tearDown := bbv1test.SetupBBServerClient(ctx, t)
			defer tearDown()
			...
			assert.Equal(t, tt.isAllowed, got, "VCS.IsAllowed() = %v, want %v", got, tt.isAllowed)
		})
	}
}
