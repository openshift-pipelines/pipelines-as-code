...
func TestGetGitOpsCommentPrefix(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := getGitOpsCommentPrefix(tt.comment, tt.repo)
